 ...
 * intermédiaire et de la génération du code assembleur ainsi que l'exécution du
 * code assembleur généré par le compilateur sur chaîne de caractères en entrée
...
class SuccessfulMilestonesTest extends common.SuccessfulMilestonesTest {
	...
	void setUp() {
		...
		// ne pas s'arrêter après la génération du code assembleur
		Compiler.doNotStopAfterAssemblyCodeGeneration();
	}
