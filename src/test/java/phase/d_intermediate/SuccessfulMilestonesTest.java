...
/**
 * Test des phases syntaxiques et sémantiques, et de la génération de la forme
 * intermédiaire du compilateur sur chaîne de caractères en entrée et sur
 * fichiers du répertoire {@code src/test/resources/Jalons}.
 * 
 * @author Denis Conan
 */
class SuccessfulMilestonesTest extends common.SuccessfulMilestonesTest {
	...
	void setUp() {
		...
		// s'arrêter après la génération de la forme intermédiaire
