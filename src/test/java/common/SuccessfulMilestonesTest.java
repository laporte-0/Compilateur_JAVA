...
/**
 * Test du compilateur sur chaînes de caractères en entrée et sur fichiers du
 * répertoire {@code src/test/resources/Jalons}.
 * 
 * <p>
 * Cette classe est abstraite pour laisser la possibilité de choisir la phase
 * dans les classes enfants.
 * 
 * @author Pascal Hennequin
 * @author Denis Conan
 */
public abstract class SuccessfulMilestonesTest {
	/**
	 * Une classe exemple.
	 */
	...
	protected void jalonString1() {
		Assertions.assertDoesNotThrow(() -> stringCompiler(jalons[0]));
	}
