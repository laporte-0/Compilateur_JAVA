...
public record IntermediateRepresentation(List<IRQuadruple> program, Scope rootScope, List<IRTempVar> tempos,
	...
	/**
	 * construit une variable temporaire IR. Nom de la variable auto-généré
	 * 
	 * @param scope le nom de la méthode courante.
	 * @return la variable IR.
	 */
	public IRTempVar buildTemp(final String scope) {
	...
	/**
	 * construit une constante IR. Nom de la variable {@code = value.toString()}.
	 * 
	 * @param value la constante entière.
	 * @return la variable IR.
	 */
	public IRConst buildConst(final int value) {
	...
	/**
	 * construit un label temporaire. Nom de label auto-généré.
	 * 
	 * @return la variable IR.
	 */
	public IRLabel buildLabel() {
	...
	/**
	 * construit un label de méthode.
	 * 
	 * @param name le nom de la méthode.
	 * @return la variable IR.
	 */
	public IRLabel buildLabel(final String name) {
