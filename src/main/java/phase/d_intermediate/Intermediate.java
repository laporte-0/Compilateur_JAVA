...
public class Intermediate extends AstVisitorDefault {
     ...
     * @return le label.
     */
    protected IRLabel buildLabel() {
        return this.ir.buildLabel();
    }
     ...
     * @return le label.
     */
    protected IRLabel buildLabel(final String name) {
        return this.ir.buildLabel(name);
    }
     ...
     * @return la constante.
     */
    protected IRConst buildConst(final int value) {
        return this.ir.buildConst(value);
    }
    ...
    protected IRTempVar newTemp() {
        return this.ir.buildTemp(this.currentMethod);
    }
