 ...
 */
public record ExprOpBin(String label, List<AstNode> enfants, AstLocations locations, Expr expr1, MJOperators op,
     ...
     */
    public static ExprOpBin build(final Expr expr1, final MJOperators op, final Expr expr2) {
