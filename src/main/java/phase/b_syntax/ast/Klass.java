...
public record Klass(String label, List<AstNode> enfants, AstLocations locations, Ident klassId, Ident parentId,
        AstList<Variable> vars, AstList<AstMethod> methods) implements AstNode {
    @Override
     ...
     */
    public static Klass build(final Ident klassId, final Ident parentId, final AstList<Variable> vars,
            final AstList<AstMethod> methods) {
