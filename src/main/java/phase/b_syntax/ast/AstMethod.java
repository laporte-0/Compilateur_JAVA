 ...
 * d'éviter les collisions avec la classe {@link java.lang.Method}.
 * </p>
 * 
 ...
 */
public record AstMethod(String label, List<AstNode> enfants, AstLocations locations, Type returnType, Ident methodId,
	 ...
	 */
	public static AstMethod build(final Type returnType, final Ident methodId, final AstList<Formal> fargs,
			final AstList<Variable> vars, final AstList<Stmt> stmts, final Expr returnExp) {
		return new AstMethod(AstMethod.class.getSimpleName(),
