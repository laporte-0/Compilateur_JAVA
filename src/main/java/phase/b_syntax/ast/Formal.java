 ...
 */
public record Formal(String label, List<AstNode> enfants, AstLocations locations, Type type, Ident varId)
		implements AstNode {
	@Override
	 ...
	 */
	public static Formal build(final Type typeId, final Ident varId) {
